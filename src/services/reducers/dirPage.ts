...
const dirPage = createSlice({
  ...
  reducers: {
    ...
    addHiddenDirectionsIDs(state, action: { payload: Array<number> }) {
      const updatedHiddenDirectionsIDs = [
        ...new Set([...state.hiddenDirectionsIDs, ...action.payload]),
      ];
    ...
    addReversedDirectionsIDs(state, action: { payload: Array<number> }) {
      const updatedReversedDirectionsIDs = [
        ...new Set([...state.reversedDirectionsIDs, ...action.payload]),
      ];
    ...
    toggleCommentsInput(state) {
      ...
      localStorage.setItem(
        'dirPage_isCommentsInputVisible',
